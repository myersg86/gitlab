      ...
      module BackgroundMigrationHelpers
        ...
        def queue_background_migration_jobs_by_range_at_intervals(model_class, job_class_name, delay_interval, batch_size: BACKGROUND_MIGRATION_BATCH_SIZE, other_job_arguments: [], initial_delay: 0, track_jobs: false)
          ...
          model_class.each_batch(of: batch_size) do |relation, index|
            ...
            track_in_database(job_class_name, start_id, end_id, arguments: other_job_arguments) if track_jobs
        ...
        def track_in_database(job_class_name, start_id, end_id, arguments: [])
          Gitlab::BackgroundMigrationJob.create!(
            name: job_class_name,
            start_id: start_id,
            end_id: end_id,
            arguments: arguments)
