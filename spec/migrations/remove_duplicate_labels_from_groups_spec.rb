...
RSpec.describe RemoveDuplicateLabelsFromGroup do
  ...
  describe 'removing full duplicates' do
    ...
    context 'with duplicates with no relationships' do
      # can't use the activerecord class because the `type` makes it think it has polymorphism and should be/have a Label subclass
    ...
    context 'multiple duplicates, a subset of which have relationships' do
      ...
      it 'creates the correct backup records' do
        ...
        # can't use the activerecord class because the `type` column makes it think it has polymorphism and should be/have a Label subclass
