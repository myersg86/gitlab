...
describe('dashboard invalid url parameters', () => {
  ...
  describe('yml form', () => {
    ...
    it('form has a text area with a default value', () => {
      ...
      expect(value).toEqual(expect.stringContaining('title:'));
      expect(value).toEqual(expect.stringContaining('type:'));
    });
    ...
    it('"copy to clipboard" button works', () => {
      ...
      expect(clipboardText).toEqual(expect.stringContaining('title:'));
      expect(clipboardText).toEqual(expect.stringContaining('type:'));
    ...
    describe('when form is pre-filled', () => {
      const mockYmlContent = 'preloaded yml content';
      ...
      it('fetches an initial panel preview', () => {
        expect(store.dispatch).toHaveBeenCalledWith(
          'monitoringDashboard/fetchPanelPreview',
          mockYmlContent,
        );
