...
describe Project do
  ...
  describe '#rename_repo' do
    context 'when running on a primary node' do
      ...
      it 'does not log the Geo::RepositoryRenamedEvent for project backed by hashed storage' do
        ...
        expect { project_hashed_storage.rename_repo }.not_to change(Geo::RepositoryRenamedEvent, :count)
      end
