...
RSpec.describe Clusters::Cluster, :use_clean_rails_memory_store_caching do
  ...
  describe '#calculate_reactive_cache' do
    ...
    context 'cluster is enabled' do
      ...
      let(:expected_nodes) { { nodes: nil, metrics_connection_error: nil, node_connection_error: nil } }
      ...
      context 'cluster cannot be reached' do
        let(:connection_status) { { connection_status: :unreachable, connection_error: :kubernetes_connection_error } }
      ...
      context 'cluster cannot be authenticated to' do
        let(:connection_status) { { connection_status: :authentication_failure, connection_error: :kubernetes_authentication_error } }
      ...
      describe 'Kubeclient::HttpError' do
        let(:connection_status) { { connection_status: :authentication_failure, connection_error: :kubeclient_http_error } }
        let(:error_code) { 403 }
        ...
        context 'generic timeout' do
          let(:connection_status) { { connection_status: :unreachable, connection_error: :kubeclient_http_error } }
