...
### Step 3. Regenerating the authorized keys in the secondary node
...
Mwanwhile, the primary node will start to notify changes to the secondary, which
will act on those notifications immediatel. Make sure the secondary instance is
...
[Step 5: Enabling the secondary GitLab node](#step-5-enabling-the-secondary-gitlab-node)
