...
- Pods that receive routed traffic from NGINX Ingress should be deployed into a namespace matching the default [KUBE_NAMESPACE](https://docs.gitlab.com/ee/user/project/clusters/index.html#deployment-variables) format.
