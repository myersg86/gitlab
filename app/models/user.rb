...
class User < ActiveRecord::Base
  ...
  has_many :epics,                    dependent: :destroy, foreign_key: :author_id # rubocop:disable Cop/ActiveRecordDependent

  has_many :issue_assignees
  has_many :assigned_issues, class_name: "Issue", through: :issue_assignees, source: :issue
  has_many :assigned_merge_requests,  dependent: :nullify, foreign_key: :assignee_id, class_name: "MergeRequest" # rubocop:disable Cop/ActiveRecordDependent
  has_many :assigned_epics,  dependent: :nullify, foreign_key: :assignee_id, class_name: "Epic" # rubocop:disable Cop/ActiveRecordDependent
