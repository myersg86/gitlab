...
module IssuablesHelper
  ...
  def issuable_meta(issuable, project, text)
    ...
    output << content_tag(:span, (sprite_icon('first-contribution', size: 24, css_class: 'gl-icon gl-vertical-align-middle') if issuable.first_contribution?), class: 'has-tooltip gl-ml-2', title: _('1st contribution!'))
